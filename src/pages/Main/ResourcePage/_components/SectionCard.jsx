const SectionCard = ({ id, title, desc, image, btnText }) => {
  return (
    <div id={id} className="flex flex-col gap-4 lg:gap-6">
      <h3
...
"
      ...
      <button className="text-sm lg:text-[16px] font-bold text-white bg-[#FF6A0C] rounded-[12px] w-full max-w-[200px] py-3 cursor-pointer mt-2 active:scale-95 transition duration-100">
        {btnText || `Know More`}
      </button>
    </div>
  );
