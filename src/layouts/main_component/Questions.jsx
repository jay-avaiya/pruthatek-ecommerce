const Questions = () => {
  ...
  return (
    <div className="w-full h-fit font-inter text-[#333333] px-4 md:px-6 lg:px-12 xl:px-24">
      ...
      {/* questions */}
      <div className="w-full max-w-[890px] mx-auto mt-24 flex flex-col gap-5 md:gap-12">
        ...
        <div className="flex flex-col items-center text-center gap-8 mt-16">
          ...
          <button className="w-[300px] bg-[#FF6A0C] text-white py-3 px-12 rounded-[14px] text-[16px] font-bold cursor-pointer">
            Book a Demo
          </button>
        </div>
      </div>
